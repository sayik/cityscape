...
export const mcpTopics: McpTopic[] = [
  {
    ...
    de: {
      ...
      lead: "Aktuelle Wetterdaten des Deutschen Wetterdienstes (DWD) für 84 deutsche Großstädte direkt in deinem KI-Assistenten, über das kostenlose, keylose MCP-Tool von cityscape. Kein API-Schlüssel, keine Installation.",
      ...
      keywords: [
        "Wetter MCP Server",
        "DWD MCP Server",
        "MCP Server Wetter Deutschland",
        "Wetter Tool Claude",
        "MCP Wetterdaten",
      ],
      faq: [
        {
          q: "Brauche ich für den Wetter-MCP-Server einen API-Schlüssel?",
          a: "Nein. Der cityscape-MCP-Server ist keylos und kostenlos. Du verbindest ihn einmal mit Claude oder ChatGPT, danach ruft der Assistent das weather-Tool ohne Schlüssel auf.",
        },
        {
          q: "Woher stammen die Wetterdaten?",
          a: "Vom Deutschen Wetterdienst (DWD), durchgereicht unter DL-DE BY 2.0. Quelle und Zeitstempel stehen in jeder Antwort.",
        },
      ],
    },
    en: {
      ...
      lead: "Current German Weather Service (DWD) data for 84 major German cities directly in your AI assistant, through cityscape's free, keyless MCP tool. No API key, no install.",
      ...
      faq: [
        {
          q: "Do I need an API key for the weather MCP server?",
          a: "No. The cityscape MCP server is keyless and free. You connect it once to Claude or ChatGPT, then the assistant calls the weather tool without a key.",
        },
        {
          q: "Where does the weather data come from?",
          a: "From the German Weather Service (DWD), passed through under DL-DE BY 2.0. Source and timestamp are in every response.",
        },
      ],
    },
  },
  {
    ...
    de: {
      ...
      lead: "Aktuelle Luftqualitätsdaten des Umweltbundesamts (UBA) für deutsche Großstädte direkt in Claude oder ChatGPT, über das kostenlose, keylose MCP-Tool von cityscape.",
      ...
      keywords: [
        "Luftqualität MCP Server",
        "UBA MCP Server",
        "Feinstaub MCP",
        "MCP Server Luftqualität Deutschland",
        "Air Quality MCP",
      ],
      faq: [
        {
          q: "Ist der Luftqualitäts-MCP-Server kostenlos?",
          a: "Ja, kostenlos und keylos. Einmal mit dem KI-Client verbinden, dann ruft er das air_quality-Tool ohne Schlüssel auf.",
        },
        {
          q: "Welche Werte liefert das Tool?",
          a: "PM10, PM2.5, NO2, O3 und SO2 aus dem Messnetz des Umweltbundesamts, mit Messzeitpunkt und Stationsbezug.",
        },
      ],
    },
    en: {
      ...
      lead: "Current German Environment Agency (UBA) air quality data for major German cities directly in Claude or ChatGPT, through cityscape's free, keyless MCP tool.",
      ...
      keywords: [
        ...
        "UBA MCP server",
        "particulate matter MCP",
        "Germany air quality MCP",
        "air quality MCP tool",
      ],
      faq: [
        {
          q: "Is the air quality MCP server free?",
          a: "Yes, free and keyless. Connect it once to your AI client, then it calls the air_quality tool without a key.",
        },
        {
          q: "Which values does the tool return?",
          a: "PM10, PM2.5, NO2, O3 and SO2 from the German Environment Agency network, with measurement time and station reference.",
        },
      ],
    },
  },
  {
    ...
    de: {
      ...
      lead: "Der bundesweite Day-Ahead-Börsenstrompreis (SMARD, Bundesnetzagentur) direkt in deinem KI-Assistenten, über das kostenlose, keylose MCP-Tool von cityscape.",
      ...
      keywords: [
        "Strompreis MCP Server",
        "SMARD MCP Server",
        "Börsenstrompreis MCP",
        "MCP Server Strompreis",
        "Energie MCP Deutschland",
      ],
      faq: [
        {
          q: "Ist der Strompreis pro Stadt unterschiedlich?",
          a: "Nein, der Day-Ahead-Börsenstrompreis gilt bundesweit. Du fragst ihn bequem über jede Stadt ab, der Wert ist derselbe.",
        },
        {
          q: "Kostet der Strompreis-MCP-Server etwas?",
          a: "Nein, kostenlos und keylos. Im Gegensatz zu vielen Energie-APIs ohne Anmeldung oder Abo nutzbar.",
        },
      ],
    },
    en: {
      ...
      lead: "The nationwide day-ahead spot electricity price (SMARD, Federal Network Agency) directly in your AI assistant, through cityscape's free, keyless MCP tool.",
      ...
      keywords: [
        ...
        "spot price MCP",
        "Germany energy MCP",
        "power price MCP tool",
      ],
      faq: [
        {
          q: "Does the electricity price differ per city?",
          a: "No, the day-ahead spot price is nationwide. You query it conveniently via any city, the value is the same.",
        },
        {
          q: "Does the electricity price MCP server cost anything?",
          a: "No, free and keyless. Unlike many energy APIs, usable without sign-up or subscription.",
        },
      ],
    },
  },
  {
    ...
    de: {
      ...
      lead: "Amtliche Bodenrichtwerte (BORIS) je Stadt direkt in Claude oder ChatGPT, über das kostenlose, keylose MCP-Tool von cityscape.",
      ...
      keywords: [
        "Bodenrichtwerte MCP Server",
        "BORIS MCP Server",
        "Grundstückspreise MCP",
        "MCP Server Immobilien Deutschland",
        "land values MCP",
      ],
      faq: [
        {
          q: "Welche Städte deckt das Tool ab?",
          a: "Alle Städte, deren Bundesland einen offenen BORIS-Dienst bereitstellt. Wo das fehlt, antwortet das Tool ehrlich mit not_covered.",
        },
        {
          q: "Ist der Bodenrichtwerte-MCP-Server kostenlos?",
          a: "Ja, kostenlos und keylos, ohne Anmeldung.",
        },
      ],
    },
    en: {
      ...
      lead: "Official standard land values (BORIS) per city directly in Claude or ChatGPT, through cityscape's free, keyless MCP tool.",
      ...
      keywords: [
        "land values MCP server",
        "BORIS MCP server",
        "property prices MCP",
        "Germany real estate MCP",
        "land value MCP tool",
      ],
      faq: [
        {
          q: "Which cities does the tool cover?",
          a: "All cities whose federal state provides an open BORIS service. Where it is missing, the tool answers honestly with not_covered.",
        },
        {
          q: "Is the land values MCP server free?",
          a: "Yes, free and keyless, without sign-up.",
        },
      ],
    },
  },
  {
    ...
    de: {
      ...
      lead: "Echtzeit-Abfahrten an Haltestellen deutscher Großstädte direkt in deinem KI-Assistenten, über das kostenlose, keylose MCP-Tool von cityscape (DELFI, GTFS, Verkehrsverbünde).",
      ...
      keywords: [
        ...
        "Abfahrten MCP",
        "GTFS MCP Server",
        "MCP Server ÖPNV Deutschland",
        "public transport MCP",
      ],
      faq: [
        {
          q: "Welche Verkehrsdaten liefert das Tool?",
          a: "Echtzeit-Abfahrten mit Linie, Richtung, geplanter und prognostizierter Zeit sowie Verspätung, aus DELFI, GTFS und regionalen Verbünden.",
        },
        {
          q: "Ist der ÖPNV-MCP-Server kostenlos?",
          a: "Ja, kostenlos und keylos, ohne Anmeldung.",
        },
      ],
    },
    en: {
      ...
      lead: "Real-time departures at stops in major German cities directly in your AI assistant, through cityscape's free, keyless MCP tool (DELFI, GTFS, transit associations).",
      ...
      keywords: [
        "public transport MCP server",
        "departures MCP",
        "GTFS MCP server",
        "Germany transit MCP",
        "real-time transit MCP",
      ],
      faq: [
        {
          q: "Which transit data does the tool return?",
          a: "Real-time departures with line, direction, planned and predicted time and delay, from DELFI, GTFS and regional associations.",
        },
        {
          q: "Is the public transport MCP server free?",
          a: "Yes, free and keyless, without sign-up.",
        },
      ],
    },

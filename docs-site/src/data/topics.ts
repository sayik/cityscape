...
export const topics: Topic[] = [
  {
    ...
    de: {
      ...
      keywords: [
        "Wetter API Deutschland",
        "DWD API",
        "keylose Wetter API",
        "Wetterdaten API kostenlos",
        "Wetter API JSON",
        "Wetterstation API",
      ],
      coverageNote:
        "Wetterdaten sind für alle 84 abgedeckten Großstädte verfügbar (nächstgelegene DWD-Station).",
      faq: [
        {
          q: "Brauche ich einen API-Schlüssel für die Wetter-API?",
          a: "Nein. Die cityscape-Wetter-API ist keylos und kostenlos. Ein einfacher GET-Request ohne Anmeldung genügt, das Rate-Limit liegt bei 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Woher kommen die Wetterdaten?",
          a: "Die Daten stammen vom Deutschen Wetterdienst (DWD) und werden unverändert unter der Lizenz DL-DE BY 2.0 durchgereicht. Jede API-Antwort enthält Quelle, Lizenz-URL und Beobachtungszeitpunkt.",
        },
        {
          q: "Wie aktuell sind die Werte?",
          a: "Die API liefert die jeweils jüngste verfügbare DWD-Beobachtung. Der Zeitpunkt steht als observed_at in jeder Antwort, dazu ein Cache-Status im meta-Block.",
        },
      ],
      datasetName: "cityscape Wetterdaten deutscher Großstädte (DWD)",
      datasetDesc:
        "Aktuelle Wetterbeobachtungen (Temperatur, Luftfeuchte, Wind, Wetterlage) für 84 deutsche Großstädte aus DWD-Stationsdaten, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      slug: "weather-api",
      ...
      faq: [
        {
          q: "Do I need an API key for the weather API?",
          a: "No. The cityscape weather API is keyless and free. A simple GET request without sign-up is enough; the rate limit is 300 requests per minute per IP.",
        },
        {
          q: "Where does the weather data come from?",
          a: "Data comes from the German Weather Service (DWD) and is passed through unchanged under the DL-DE BY 2.0 license. Every API response carries the source, license URL and observation time.",
        },
        {
          q: "How current are the values?",
          a: "The API returns the most recent available DWD observation. The time is exposed as observed_at on every response, with a cache status in the meta block.",
        },
      ],
      datasetName: "cityscape weather data for German cities (DWD)",
      datasetDesc:
        "Current weather observations (temperature, humidity, wind, condition) for 84 major German cities from DWD station data, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "air-quality",
    ...
    de: {
      ...
      keywords: [
        "Luftqualität API Deutschland",
        "Feinstaub API",
        "UBA API",
        "Luftqualitäts API kostenlos",
        "NO2 PM10 API",
        "Air Quality API Germany",
      ],
      coverageNote:
        "Luftqualitätsdaten richten sich nach dem UBA-Messnetz; abgefragt wird die jeweils nächstgelegene Station.",
      faq: [
        {
          q: "Ist die Luftqualitäts-API kostenlos und ohne Schlüssel nutzbar?",
          a: "Ja. Die API ist keylos und kostenlos, ein GET-Request ohne Anmeldung genügt. Das Rate-Limit beträgt 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Welche Schadstoffe sind enthalten?",
          a: "Feinstaub PM10 und PM2.5, Stickstoffdioxid NO2, Ozon O3 und Schwefeldioxid SO2 aus dem Messnetz des Umweltbundesamts, mit Messzeitpunkt und Stationsbezug je Wert.",
        },
        {
          q: "Welche Lizenz gilt für die Luftdaten?",
          a: "Die UBA-Daten werden unter DL-DE BY 2.0 durchgereicht. Die Lizenz-URL und der Attributionstext stehen in jeder API-Antwort im attribution-Block.",
        },
      ],
      datasetName: "cityscape Luftqualitätsdaten deutscher Großstädte (UBA)",
      datasetDesc:
        "Aktuelle Luftqualitätswerte (PM10, PM2.5, NO2, O3, SO2) für deutsche Großstädte aus dem Messnetz des Umweltbundesamts, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      ...
      keywords: [
        ...
        "UBA API",
        "free air quality API",
        "NO2 PM10 API",
        "German air quality data API",
      ],
      coverageNote:
        "Air quality data follows the UBA monitoring network; the nearest station is queried per city.",
      faq: [
        {
          q: "Is the air quality API free and usable without a key?",
          a: "Yes. The API is keyless and free; a GET request without sign-up is enough. The rate limit is 300 requests per minute per IP.",
        },
        {
          q: "Which pollutants are included?",
          a: "Particulate matter PM10 and PM2.5, nitrogen dioxide NO2, ozone O3 and sulphur dioxide SO2 from the German Environment Agency network, with measurement time and station reference per value.",
        },
        {
          q: "Which license applies to the air data?",
          a: "UBA data is passed through under DL-DE BY 2.0. The license URL and attribution text are included in every API response in the attribution block.",
        },
      ],
      datasetName: "cityscape air quality data for German cities (UBA)",
      datasetDesc:
        "Current air quality values (PM10, PM2.5, NO2, O3, SO2) for major German cities from the German Environment Agency network, free and keyless via a JSON REST API.",
    },
  },
  {
    ...
    de: {
      ...
      licenseUrl: "https://www.govdata.de/dl-de/by-2-0",
      vars: [
        "Day-Ahead-Börsenstrompreis (EUR/MWh)",
        "Bezugszeitpunkt",
        "Netzlast der Regelzone (über power-load)",
      ],
      keywords: [
        "Strompreis API",
        "SMARD API",
        "Börsenstrompreis API",
        "Day Ahead Strompreis API",
        "Strompreis API kostenlos",
        "Energiedaten API Deutschland",
      ],
      coverageNote:
        "Der Day-Ahead-Preis ist bundesweit, also für alle 84 Städte über denselben Wert abrufbar. Die Netzlast (power-load) bezieht sich auf die jeweilige Regelzone.",
      faq: [
        {
          q: "Ist die Strompreis-API kostenlos und keylos?",
          a: "Ja. Kein Schlüssel, keine Anmeldung, kostenlos, ein GET-Request genügt. Das Rate-Limit beträgt 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Ist der Strompreis pro Stadt unterschiedlich?",
          a: "Nein. Der Day-Ahead-Börsenstrompreis gilt für ganz Deutschland einheitlich. Der Abruf über einen Stadt-Slug ist nur bequemer Zugang zu demselben bundesweiten Wert.",
        },
        {
          q: "Eignet sich die API für Smart Home oder dynamische Tarife?",
          a: "Ja. Der Tageswert lässt sich keylos abrufen und etwa in Home Assistant oder ioBroker einbinden, um Verbraucher in günstige Stunden zu legen.",
        },
      ],
      datasetName: "cityscape Strompreisdaten Deutschland (SMARD)",
      datasetDesc:
        "Bundesweiter Day-Ahead-Börsenstrompreis und Netzlast aus SMARD-Daten der Bundesnetzagentur, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      ...
      keywords: [
        ...
        "SMARD API",
        "spot electricity price API",
        "day ahead electricity price API",
        "free electricity price API",
        "Germany energy data API",
      ],
      coverageNote:
      ...
      faq: [
        {
          q: "Is the electricity price API free and keyless?",
          a: "Yes. No key, no sign-up, free, a single GET request is enough. The rate limit is 300 requests per minute per IP.",
        },
        {
          q: "Does the electricity price differ per city?",
          a: "No. The day-ahead spot price is uniform across Germany. Retrieving it via a city slug is just convenient access to the same national value.",
        },
        {
          q: "Is the API suitable for smart home or dynamic tariffs?",
          a: "Yes. The daily value can be fetched keyless and integrated into Home Assistant or ioBroker, for example to shift loads into cheaper hours.",
        },
      ],
      datasetName: "cityscape electricity price data Germany (SMARD)",
      datasetDesc:
        "Nationwide day-ahead spot electricity price and grid load from SMARD data of the Federal Network Agency, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "land-values",
    ...
    de: {
      ...
      vars: [
        "Median-Bodenrichtwert (EUR/m²)",
        "Minimum-Bodenrichtwert",
        "Maximum-Bodenrichtwert",
        "Anzahl Bodenrichtwertzonen",
        "Stichtag",
      ],
      keywords: [
        "Bodenrichtwerte API",
        "BORIS API",
        "Bodenrichtwert Deutschland API",
        "Grundstückspreise API",
        "Bauland API",
        "Immobiliendaten API",
      ],
      coverageNote:
        "Bodenrichtwerte sind dort verfügbar, wo das jeweilige Land einen offenen BORIS-Dienst bereitstellt.",
      faq: [
        {
          q: "Ist die Bodenrichtwerte-API kostenlos und keylos?",
          a: "Ja. Kein Schlüssel, keine Anmeldung, kostenlos, ein GET-Request genügt. Das Rate-Limit beträgt 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Was bedeutet die Bauland-Kennzahl?",
          a: "Es ist der Median der Bodenrichtwerte einer Stadt, gefiltert auf Bauland (Wohnen, Misch, Gewerbe), plus Minimum, Maximum, Zonenzahl und Stichtag. So bleibt der Wert aussagekräftig und nicht durch Wald- oder Wasserflächen verzerrt.",
        },
        {
          q: "Warum ist nicht jede Stadt abgedeckt?",
          a: "Bodenrichtwerte werden je Bundesland bereitgestellt. Wo ein Land keinen offenen BORIS-Dienst anbietet (etwa lizenzbeschränkt), antwortet die API ehrlich mit not_covered statt zu raten.",
        },
      ],
      datasetName: "cityscape Bodenrichtwerte deutscher Städte (BORIS)",
      datasetDesc:
        "Amtliche Bodenrichtwerte als Bauland-Kennzahl (Median, Minimum, Maximum, Zonen, Stichtag) je Stadt aus BORIS-Diensten der Länder, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      ...
      keywords: [
        "land values API",
        "BORIS API",
        "standard land value Germany API",
        "property prices API",
        "building land API",
        "real estate data API Germany",
      ],
      coverageNote:
        "Land values are available where the respective state provides an open BORIS service.",
      faq: [
        {
          q: "Is the land values API free and keyless?",
          a: "Yes. No key, no sign-up, free, a single GET request is enough. The rate limit is 300 requests per minute per IP.",
        },
        {
          q: "What does the building-land metric mean?",
          a: "It is the median of a city's standard land values, filtered to building land (residential, mixed, commercial), plus minimum, maximum, zone count and reference date. This keeps the value meaningful and not distorted by forest or water areas.",
        },
        {
          q: "Why is not every city covered?",
          a: "Standard land values are provided per federal state. Where a state offers no open BORIS service (for example license-restricted), the API answers honestly with not_covered instead of guessing.",
        },
      ],
      datasetName: "cityscape land values for German cities (BORIS)",
      datasetDesc:
        "Official standard land values as a building-land metric (median, minimum, maximum, zones, reference date) per city from state BORIS services, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "solar",
    ...
    de: {
      ...
      licenseUrl:
        "https://joint-research-centre.ec.europa.eu/photovoltaic-geographical-information-system-pvgis_en",
      vars: [
        "Jahres-PV-Ertrag (kWh/kWp)",
        "Globalstrahlung (kWh/m²)",
        "Optimaler Neigungswinkel (Grad)",
        "Optimales Azimut (Grad, 0 = Süd)",
        "12 Monatswerte (Ertrag + Einstrahlung)",
        "Bezugszeitraum (Jahresspanne)",
      ],
      keywords: [
        "Solar API Deutschland",
        "PVGIS API",
        "Solarpotenzial API",
        "Photovoltaik Ertrag API",
        "Globalstrahlung API",
        "PV Ertrag API kostenlos",
      ],
      coverageNote:
        "Solar-Daten sind für alle 84 abgedeckten Städte verfügbar: PVGIS rechnet jede Koordinate in Europa, die Werte beziehen sich auf das Stadtzentrum.",
      faq: [
        {
          q: "Ist die Solar-API kostenlos und keylos?",
          a: "Ja. Kein Schlüssel, keine Anmeldung, kostenlos, ein GET-Request genügt. Das Rate-Limit beträgt 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Was bedeutet der Wert kWh pro kWp?",
          a: "Es ist der zu erwartende Jahresertrag einer Photovoltaikanlage je installiertem Kilowatt-Peak bei optimalem Neigungswinkel. So lassen sich Standorte direkt vergleichen und auf die geplante Anlagengröße hochrechnen.",
        },
        {
          q: "Sind das aktuelle Messwerte?",
          a: "Nein. PVGIS liefert ein klimatologisches Mehrjahresmittel, also einen langjährigen Durchschnitt statt eines Tageswerts. Deshalb ist observed_at null; der Bezugszeitraum steht als Jahresspanne (period_start/period_end) in der Antwort.",
        },
      ],
      datasetName: "cityscape Solardaten deutscher Städte (PVGIS)",
      datasetDesc:
        "Solar-Einstrahlung und normierter PV-Ertrag (kWh/kWp, kWh/m², optimaler Winkel, Monatswerte) für 84 deutsche Städte aus PVGIS-Daten der Europäischen Kommission, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      slug: "solar-api",
      ...
      keywords: [
        ...
        "PVGIS API",
        "solar potential API",
        "photovoltaic yield API",
        "solar irradiation API",
        "free PV yield API",
      ],
      coverageNote:
      ...
      faq: [
        {
          q: "Is the solar API free and keyless?",
          a: "Yes. No key, no sign-up, free, a single GET request is enough. The rate limit is 300 requests per minute per IP.",
        },
        {
          q: "What does kWh per kWp mean?",
          a: "It is the expected annual yield of a photovoltaic system per installed kilowatt-peak at the optimal tilt. This lets you compare locations directly and scale to your planned system size.",
        },
        {
          q: "Are these live measurements?",
          a: "No. PVGIS provides a multi-year climatological average, a long-term mean rather than a daily value. That is why observed_at is null; the reference period is given as a year range (period_start/period_end) in the response.",
        },
      ],
      datasetName: "cityscape solar data for German cities (PVGIS)",
      datasetDesc:
        "Solar irradiation and normalized PV yield (kWh/kWp, kWh/m², optimal tilt, monthly values) for 84 German cities from European Commission PVGIS data, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "solar-roofs",
    ...
    de: {
      ...
      sourceName:
        "Solarkataster der Länder (NRW: LANUK/Geobasis NRW; Bayern: LfU; Berlin: Umweltatlas; Hamburg: LGV)",
      sourceUrl:
        "https://www.opengeodata.nrw.de/produkte/umwelt_klima/energie/solarkataster/",
      license:
        "DL-DE Zero 2.0 (NRW, Berlin), CC BY 4.0 (Bayern), DL-DE BY 2.0 (Hamburg)",
      licenseUrl: "https://www.govdata.de/dl-de/zero-2-0",
      vars: [
        "Installierbares Potenzial (kWp)",
        "Potenzieller Jahresertrag (MWh)",
        "Installierter Bestand (kWp)",
        "Ausschöpfungsgrad (%)",
        "Potenzial je Gebäudekategorie (NRW)",
        "Stichtag",
      ],
      keywords: [
        "Solarkataster API",
        "Dach-PV Potenzial API",
        "Solarpotenzial API Deutschland",
        "Photovoltaik Dachflächen API",
        "PV Potenzial Stadt API",
        "Solarkataster NRW Bayern Berlin Hamburg Daten",
      ],
      coverageNote:
        "Das Dach-Solarkataster ist pro Bundesland föderiert. Aktuell abgedeckt sind die Städte in Nordrhein-Westfalen und Bayern sowie die Stadtstaaten Berlin und Hamburg; weitere Länder folgen, sobald ihr offenes Gemeinde-Aggregat vorliegt.",
      faq: [
        {
          q: "Ist die Solarkataster-API kostenlos und keylos?",
          a: "Ja. Kein Schlüssel, keine Anmeldung, kostenlos, ein GET-Request genügt. Das Rate-Limit beträgt 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Worin unterscheidet sich diese API von der Solar-API?",
          a: "Die Solar-API (PVGIS) liefert die Sonneneinstrahlung und den erwartbaren Ertrag je installiertem Kilowatt-Peak für jede Stadt. Diese Solarkataster-API liefert das tatsächliche Dachpotenzial je Stadt: wie viel PV installierbar ist und wie viel davon bereits installiert ist.",
        },
        {
          q: "Welche Länder sind abgedeckt?",
          a: "Aktuell Nordrhein-Westfalen (Solarkataster NRW, DL-DE Zero 2.0), Bayern (Energie-Atlas Bayern, CC BY 4.0), Berlin (Umweltatlas, DL-DE Zero 2.0) und Hamburg (Solarpotenzialanalyse, DL-DE BY 2.0). Dach-Solarkataster werden je Bundesland erhoben; weitere Länder kommen hinzu, sobald ein offenes Gemeinde-Aggregat vorliegt. Für Städte ohne abgedecktes Land antwortet die API ehrlich mit not_covered statt zu raten.",
        },
      ],
      datasetName:
        "cityscape Dach-Solarkataster (Potenzial je Stadt: NRW, Bayern, Berlin, Hamburg)",
      datasetDesc:
        "Installierbares und installiertes Dach-PV-Potenzial (kWp, MWh, Ausschöpfungsgrad) je Stadt aus den amtlichen Solarkatastern NRW, Bayern, Berlin und Hamburg, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      ...
      sourceName:
        "State solar cadastres (NRW: LANUK/Geobasis NRW; Bavaria: LfU; Berlin: Umweltatlas; Hamburg: LGV)",
      sourceUrl:
        "https://www.opengeodata.nrw.de/produkte/umwelt_klima/energie/solarkataster/",
      license:
        "DL-DE Zero 2.0 (NRW, Berlin), CC BY 4.0 (Bavaria), DL-DE BY 2.0 (Hamburg)",
      licenseUrl: "https://www.govdata.de/dl-de/zero-2-0",
      vars: [
      ...
      keywords: [
        "solar cadastre API",
        "rooftop PV potential API",
        "solar potential API Germany",
        "photovoltaic rooftop API",
        "PV potential city API",
        "Solarkataster NRW Bavaria Berlin Hamburg data",
      ],
      coverageNote:
      ...
      faq: [
        {
          q: "Is the solar cadastre API free and keyless?",
          a: "Yes. No key, no sign-up, free, a single GET request is enough. The rate limit is 300 requests per minute per IP.",
        },
        {
          q: "How does this differ from the solar API?",
          a: "The solar API (PVGIS) returns solar irradiation and the expected yield per installed kilowatt-peak for any city. This solar cadastre API returns the actual rooftop potential per city: how much PV is installable and how much is already installed.",
        },
        {
          q: "Which states are covered?",
          a: "Currently North Rhine-Westphalia (Solarkataster NRW, DL-DE Zero 2.0), Bavaria (Energie-Atlas Bayern, CC BY 4.0), Berlin (Umweltatlas, DL-DE Zero 2.0) and Hamburg (solar potential analysis, DL-DE BY 2.0). Rooftop solar cadastres are compiled per federal state; more states are added once an open municipal aggregate is available. For cities without a covered state the API answers honestly with not_covered instead of guessing.",
        },
      ],
      datasetName:
        "cityscape rooftop solar cadastre (potential per city: NRW, Bavaria, Berlin, Hamburg)",
      datasetDesc:
        "Installable and installed rooftop PV potential (kWp, MWh, exploitation ratio) per city from the official NRW, Bavaria, Berlin and Hamburg solar cadastres, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "public-transport",
    ...
    de: {
      ...
      vars: [
        ...
        "Prognostizierte Abfahrtszeit",
        "Verspätung",
        "Haltestelle",
      ],
      keywords: [
        "ÖPNV API Deutschland",
        "Abfahrten API",
        "Echtzeit ÖPNV API",
        "GTFS Echtzeit API",
        "Fahrplan API kostenlos",
        "public transport API Germany",
      ],
      coverageNote:
        "Echtzeit-Abfahrten sind für die Städte mit angebundenen Verbund- bzw. DELFI-Daten verfügbar.",
      faq: [
        {
          q: "Ist die ÖPNV-Echtzeit-API kostenlos und keylos?",
          a: "Ja. Kein Schlüssel, keine Anmeldung, kostenlos, ein GET-Request genügt. Das Rate-Limit beträgt 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Welche Daten enthält eine Abfahrt?",
          a: "Linie, Richtung und Ziel, die geplante und die prognostizierte Abfahrtszeit sowie die Verspätung, jeweils an einer zentralen Haltestelle der Stadt.",
        },
        {
          q: "Welche Quellen stehen dahinter?",
          a: "DELFI und GTFS sowie regionale Verkehrsverbünde. Die jeweils gültige Lizenz und der Attributionshinweis stehen in jeder API-Antwort.",
        },
      ],
      datasetName: "cityscape ÖPNV-Echtzeit-Abfahrten deutscher Städte",
      datasetDesc:
        "Echtzeit-Abfahrten und -Ankünfte an Haltestellen deutscher Großstädte aus DELFI-, GTFS- und Verbunddaten, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      ...
      faq: [
        {
          q: "Is the public transport API free and keyless?",
          a: "Yes. No key, no sign-up, free, a single GET request is enough. The rate limit is 300 requests per minute per IP.",
        },
        {
          q: "What data does a departure contain?",
          a: "Line, direction and destination, the planned and predicted departure time and the delay, at a central stop in the city.",
        },
        {
          q: "Which sources are behind it?",
          a: "DELFI and GTFS plus regional transit associations. The applicable license and attribution note are included in every API response.",
        },
      ],
      datasetName:
        "cityscape real-time public transport departures for German cities",
      datasetDesc:
        "Real-time departures and arrivals at stops in major German cities from DELFI, GTFS and transit association data, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "public-tenders",
    ...
    de: {
      ...
      vars: [
        "Bekanntmachungstyp (Ausschreibung/Zuschlag)",
        "Status",
        "Auftraggeber-Ort",
        "Region (NUTS)",
        "Leistungsgegenstand (CPV)",
        "Auftragswert",
      ],
      keywords: [
        "Vergabe API Deutschland",
        "öffentliche Aufträge API",
        "Ausschreibungen API",
        "OCDS API Deutschland",
        "Auftragsvergabe Daten API",
        "public procurement API Germany",
      ],
      coverageNote:
        "Die Abdeckung wächst: Oberschwellige Bekanntmachungen sind vollständig, unterschwellige werden ab 2024 schrittweise ergänzt.",
      faq: [
        {
          q: "Ist die Vergabe-API kostenlos und ohne Schlüssel nutzbar?",
          a: "Ja. Die API ist keylos und kostenlos, ein GET-Request ohne Anmeldung genügt. Das Rate-Limit beträgt 300 Anfragen pro Minute und IP.",
        },
        {
          q: "Welche Vergabedaten sind enthalten?",
          a: "Laufende Ausschreibungen und bereits vergebene Aufträge je Stadt mit Bekanntmachungstyp, Status, Auftraggeber-Ort, Region (NUTS), Leistungsgegenstand (CPV) und, soweit veröffentlicht, dem Auftragswert.",
        },
        {
          q: "Welche Lizenz gilt für die Vergabedaten?",
          a: "Die Daten stammen aus dem Datenservice Öffentlicher Einkauf und werden unter CC0 durchgereicht. Lizenz-URL und Attribution stehen in jeder API-Antwort im attribution-Block.",
        },
      ],
      datasetName:
        "cityscape Vergabedaten deutscher Städte (Datenservice Öffentlicher Einkauf)",
      datasetDesc:
        "Laufende Ausschreibungen und vergebene Aufträge deutscher Städte aus dem Datenservice Öffentlicher Einkauf (OCDS, CC0), kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      ...
      keywords: [
        ...
        "government contracts API Germany",
      ],
      coverageNote:
        "Coverage is growing: above-threshold notices are complete, below-threshold notices are added gradually from 2024 onward.",
      faq: [
        {
          q: "Is the public procurement API free and usable without a key?",
          a: "Yes. The API is keyless and free; a GET request without sign-up is enough. The rate limit is 300 requests per minute per IP.",
        },
        {
          q: "Which procurement data is included?",
          a: "Running tenders and already awarded contracts per city with notice type, status, buyer city, region (NUTS), contract subject (CPV) and, where published, the contract value.",
        },
        {
          q: "Which license applies to the procurement data?",
          a: "Data comes from the German public procurement data service and is passed through under CC0. The license URL and attribution are included in every API response in the attribution block.",
        },
      ],
      datasetName:
        "cityscape public procurement data for German cities (German procurement data service)",
      datasetDesc:
        "Running tenders and awarded contracts for German cities from the German public procurement data service (OCDS, CC0), free and keyless via a JSON REST API.",
    },
  },
];

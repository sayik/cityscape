...
from cityscape.adapters.autobahn import fetch_traffic, fetch_webcams
from cityscape.adapters.baumkataster import fetch_trees
from cityscape.adapters.bbk_nina import ars_for_ags, fetch_for_ags
from cityscape.adapters.berlin_radzaehl import fetch_berlin_radzaehl
from cityscape.adapters.berlin_viz import fetch_berlin_road_events
from cityscape.adapters.db_fasta import fetch_station_facilities
from cityscape.adapters.db_timetables import (
    fetch_station_arrivals,
    fetch_station_departures,
)
from cityscape.adapters.denkmal import fetch_heritage
from cityscape.adapters.destination_one import fetch_events
from cityscape.adapters.divi_live import fetch_icu_live
from cityscape.adapters.dortmund_baustellen import fetch_dortmund_road_events
from cityscape.adapters.duesseldorf_radzaehl import fetch_duesseldorf_radzaehl
from cityscape.adapters.dwd import fetch_weather
from cityscape.adapters.dwd_fire import fetch_fire_danger
from cityscape.adapters.dwd_pollen import fetch_pollen_uv
from cityscape.adapters.dwd_warnings import (
    extract_warncell,
    fetch_dwd_warnings_all,
    warncell_for_ags,
)
from cityscape.adapters.eea_bathing import fetch_bathing_water
from cityscape.adapters.essen_radzaehl import fetch_essen_radzaehl
from cityscape.adapters.gbfs import fetch_sharing
from cityscape.adapters.genesis import (
    fetch_demographics,
    fetch_genesis_table,
    fetch_hospitals,
)
from cityscape.adapters.hamburg_radzaehl import fetch_hamburg_radzaehl
from cityscape.adapters.hamburg_transparenz import fetch_hamburg_road_events
from cityscape.adapters.klinik_atlas import fetch_hospital_atlas
from cityscape.adapters.koeln_arcgis import fetch_koeln_road_events
from cityscape.adapters.koeln_events import fetch_events as fetch_koeln_events
from cityscape.adapters.koeln_radzaehl import fetch_koeln_radzaehl
from cityscape.adapters.koeln_wartezeiten import fetch_koeln_wartezeiten
from cityscape.adapters.leipzig_radzaehl import fetch_leipzig_radzaehl
from cityscape.adapters.lhp import fetch_flood
from cityscape.adapters.mobidata_bw import fetch_mobidata_road_events
from cityscape.adapters.mobilithek_datex2 import (
    fetch_datex2,
    fetch_magdeburg_parking,
    fetch_wuppertal_parking,
)
from cityscape.adapters.mobilithek_datex3 import fetch_frankfurt_parking
from cityscape.adapters.muenchen_opendata import (
    fetch_muenchen_parking,
    fetch_muenchen_road_events,
)
from cityscape.adapters.muenchen_radzaehl import fetch_muenchen_radzaehl
from cityscape.adapters.overpass import (
    _ALLOWED_TYPES,
    fetch_osm_feature,
    fetch_pois,
)
from cityscape.adapters.parkendd import PARKENDD_CITIES, fetch_parkendd
from cityscape.adapters.pegelonline import fetch_water_level
from cityscape.adapters.smard import fetch_smard
from cityscape.adapters.solar import fetch_solar
from cityscape.adapters.sperrinfosys import fetch_sperrinfosys_road_events
from cityscape.adapters.stada import fetch_all_stations
from cityscape.adapters.stuttgart_radzaehl import fetch_stuttgart_radzaehl
from cityscape.adapters.tankerkoenig import fetch_fuel_prices
from cityscape.adapters.uba import fetch_air_uba
from cityscape.adapters.wikidata import fetch_city_base, fetch_hospitals_wikidata
from cityscape.adapters.zensus_grid import fetch_population_density
from cityscape.api.errors import UnprocessableError, UpstreamError
from cityscape.api.v1.pagination import paginate_envelope, parse_page_params
from cityscape.archive.bka_pks_db import read_crime_stats
from cityscape.archive.boris_db import read_land_values
from cityscape.archive.inkar_db import read_indicators
from cityscape.archive.kba_db import read_vehicle_registrations
from cityscape.archive.mastr_db import read_energy
from cityscape.archive.regionalstatistik_db import (
    read_business_registrations,
    read_insolvencies,
    read_tax_rates,
)
from cityscape.archive.store import append_record, read_records
from cityscape.archive.tender_db import read_public_tenders
from cityscape.archive.transit_store import read_stops
from cityscape.archive.unfallatlas_db import read_accidents
from cityscape.charging.geomap import load_city_points
from cityscape.charging.store import get_point_statuses
from cityscape.config import Settings
from cityscape.infra.cache import build_cache_key
from cityscape.normalization.enums import SourceId
from cityscape.normalization.mappers.autobahn import (
    map_autobahn_traffic,
    map_autobahn_webcams,
)
from cityscape.normalization.mappers.baumkataster import map_trees
from cityscape.normalization.mappers.bbk_nina import map_bbk_nina
from cityscape.normalization.mappers.berlin_viz import map_berlin_road_events
from cityscape.normalization.mappers.bike_counts import (
    map_berlin_radzaehl,
...
from cityscape.normalization.mappers.bka_pks import map_crime_stats
from cityscape.normalization.mappers.boris import map_land_values
from cityscape.normalization.mappers.db_fasta import map_station_facilities
from cityscape.normalization.mappers.db_timetables import (
    map_station_arrivals,
    map_station_departures,
)
from cityscape.normalization.mappers.denkmal import map_heritage
from cityscape.normalization.mappers.destination_one import (
    map_destination_one_events,
)
from cityscape.normalization.mappers.dortmund_baustellen import (
    map_dortmund_road_events,
)
from cityscape.normalization.mappers.dwd import map_weather
from cityscape.normalization.mappers.dwd_fire import map_fire_danger
from cityscape.normalization.mappers.dwd_pollen import map_pollen_uv
from cityscape.normalization.mappers.dwd_warnings import map_dwd_warnings
from cityscape.normalization.mappers.eea_bathing import map_bathing_water
from cityscape.normalization.mappers.gbfs import map_sharing
from cityscape.normalization.mappers.genesis import (
    map_demographics,
    map_population_demographics,
    map_regional_stat,
)
from cityscape.normalization.mappers.hamburg_transparenz import map_hamburg_road_events
from cityscape.normalization.mappers.holidays import load_holidays, map_holidays
from cityscape.normalization.mappers.hospital import (
    map_hospital,
    map_hospital_wikidata,
)
from cityscape.normalization.mappers.icu_live import map_icu_live
from cityscape.normalization.mappers.inkar import map_indicators
from cityscape.normalization.mappers.kba import map_vehicle_registrations
from cityscape.normalization.mappers.klinik_atlas import map_hospital_atlas
from cityscape.normalization.mappers.koeln_arcgis import map_koeln_road_events
from cityscape.normalization.mappers.koeln_events import map_koeln_events
from cityscape.normalization.mappers.koeln_wartezeiten import map_koeln_wartezeiten
from cityscape.normalization.mappers.lhp import map_flood
from cityscape.normalization.mappers.mastr import map_mastr_assets
from cityscape.normalization.mappers.mobidata_bw import map_mobidata_road_events
from cityscape.normalization.mappers.mobilithek_afir import map_city_charging_status
from cityscape.normalization.mappers.mobilithek_bremen import map_bremen_road_events
from cityscape.normalization.mappers.mobilithek_parken import (
    map_frankfurt_parking,
    map_magdeburg_parking,
    map_wuppertal_parking,
)
from cityscape.normalization.mappers.muenchen_opendata import (
    map_muenchen_parking,
    map_muenchen_road_events,
)
from cityscape.normalization.mappers.muenchen_radzaehl import map_muenchen_radzaehl
from cityscape.normalization.mappers.overpass import map_osm_feature, map_overpass_pois
from cityscape.normalization.mappers.parkendd import map_parkendd
from cityscape.normalization.mappers.pegelonline import map_water_level
from cityscape.normalization.mappers.regionalstatistik import (
    map_business_registrations,
    map_insolvencies,
    map_tax_rates,
)
from cityscape.normalization.mappers.smard import map_smard
from cityscape.normalization.mappers.solar import map_solar
from cityscape.normalization.mappers.solar_cadastre import (
    load_solar_roofs,
    map_solar_roofs,
)
from cityscape.normalization.mappers.sperrinfosys import (
    map_sperrinfosys_road_events,
)
from cityscape.normalization.mappers.stada import map_station_catalog
from cityscape.normalization.mappers.tankerkoenig import map_fuel_prices
from cityscape.normalization.mappers.uba import map_air_uba
from cityscape.normalization.mappers.unfallatlas import map_accidents
from cityscape.normalization.mappers.wikidata import map_wikidata_city
from cityscape.normalization.mappers.zensus_grid import map_population_density
from cityscape.registry import get_city, list_cities
from cityscape.registry.catalog import CITY_DATA_CATALOG
from cityscape.registry.coverage import PARTIAL_COVERAGE, covered_cities, is_covered
from cityscape.registry.source_specs import SOURCE_LICENSE
